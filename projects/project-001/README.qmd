---
title: "Problem Set 1"
subtitle: "Cross validation and penalized regression"
format:
  html:
    toc: true
...
[**Due**]{style="text-decoration: underline;"} Sunday, 01 February 2026 11:59 PM (Pacific Time)
...
[**What?**]{style="text-decoration: underline;"} Let's integrate what we've been discussing about tuning, resampling, and penalization into the prediction context from our last project.

[**Purpose**]{style="text-decoration: underline;"} We have three main goals with this project.
...
0. Load the data into `R` along with the necessary packages.
...
*Note:* At this point, you need to have `tidymodels` and `glmnet` installed and loaded.
