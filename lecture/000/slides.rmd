...
- .note[Course website:] [https://github.com/edrubin/EC524W26/](https://github.com/edrubin/EC524W26/)
- [Syllabus](https://raw.githack.com/edrubin/EC524W26/master/syllabus/syllabus.pdf) (on website)
...
- .hi-slate[interactions and nonlinearities] likely matter;
- .hi-slate[engineering] features/variables can be important;
- .it[related:] we might not even know .hi-slate[which features] that matter;
- .hi-slate[flexibility] is huge—but we still want to avoid .hi-slate[overfitting].

--

.note[Ideal] We want to
